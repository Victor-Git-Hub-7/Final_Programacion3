package com.victor.videojuegos.entities;
...
public class Videojuego {
    ...
    @Min(value = 5,message="El precio debe tener un minimo de 5 dolares.")
    @Max(value = 10000, message="El precio debe ser menor a 200 dolares. ")
    private float precio;
    @Min(value = 1,message="El stock debe tener un minimo de 5 unidades. ")
    @Max(value = 10000, message="El stock debe ser menor a 1000 unidades. ")
    private short stock;
